...
;angular.module("ModalControllers",[]).controller("ModalToggleCtrl",["$modal",function(e){this.toggleSignOutModal=function(){e.open({templateUrl:"logout_modal.html",controller:"SimpleModalInstanceCtrl",controllerAs:"modal"})},this.toggleEditProfileModal=function(){e.open({templateUrl:"edit_profile_modal.html",controller:"SimpleModalInstanceCtrl",controllerAs:"modal"})}}]).controller("SimpleModalInstanceCtrl",["$modalInstance",function(e){this.cancel=function(){e.dismiss("cancel")}}]).controller("NewMemberModalInstanceCtrl",["$modalInstance","$controller",function(e,t){angular.extend(this,t("SimpleModalInstanceCtrl",{$modalInstance:e})),this.email="",this.addMember=function(t){return t=t.trim(),0===t.length?void e.dismiss("cancel"):(t.indexOf("@")<0&&(t+="@gmail.com"),void e.close(t))}}]).controller("DeleteTeamModalInstanceCtrl",["$modalInstance","$controller",function(e,t){angular.extend(this,t("SimpleModalInstanceCtrl",{$modalInstance:e})),this.remove=function(){e.close()}}]).controller("CreateTeamModalInstanceCtrl",["$modalInstance","$controller","user",function(e,t,n){angular.extend(this,t("SimpleModalInstanceCtrl",{$modalInstance:e})),this.teamName="",this.teamMembers="",this.includeLeader=!1;var l=this;this.add=function(){for(var t={name:l.teamName,leader:n.email,members:[]},o=l.teamMembers.split(","),a=0;a<o.length;a++){var r=o[a].trim();0!==r.length&&(r.indexOf("@")<0&&(r+="@gmail.com"),t.members.push({email:r,visibility:"NOT_CHOSEN"}))}l.includeLeader&&t.members.push({email:n.email,visibility:"ALL_MEMBERS"}),e.close(t)}}]).controller("ExportModalInstanceCtrl",["$modalInstance","$controller","team","$window",function(e,t,n,l){angular.extend(this,t("SimpleModalInstanceCtrl",{$modalInstance:e})),this.team=n,this.fullname=!0,this.username=!0,this.hasTimestamp=!0,this.timezone="Eastern",this.timezones=["UTC","Eastern","Central","Mountain","Pacific"],this.data=[];var o=this;if(n.members_progress.length>0){this.courses=n.members_progress[0].course_progress;for(var a=0;a<courses.length;a++){for(var r={name:courses[a].name,tracks:[],toggled:!1},s=courses[a].track_progress,i=0;i<s.length;i++){for(var m={name:s[i].name,units:[],toggled:!1},g=s[i].unit_progress,c=0;c<g.length;c++){var d={name:g[c].name,toggled:!1};m.units.push(d)}r.tracks.push(m)}this.data.push(r)}}var u=function(e){e.toggled=!0;for(var t=0;t<e.units.length;t++)if(!e.units[t].toggled){e.toggled=!1;break}},h=function(e){e.toggled=!0;for(var t=0;t<e.tracks.length;t++)if(!e.tracks[t].toggled){e.toggled=!1;break}};this.toggleCourse=function(e){for(var t=e.tracks,n=0;n<t.length;n++){for(var l=t[n].units,o=0;o<l.length;o++)l[o].toggled=!e.toggled;t[n].toggled=!e.toggled}e.toggled=!e.toggled},this.toggleTrack=function(e,t){for(var n=t.units,l=0;l<n.length;l++)n[l].toggled=!t.toggled;t.toggled=!t.toggled,h(e)},this.unitToggled=function(e,t){u(t),h(e)},this.generate=function(){console.log(o.data,o.fullname,o.username);var t="http://"+l.location.host+"/teams/export.csv";t+="?team_urlsafe="+n.team_key,o.fullname&&(t+="&student_name=true"),o.username&&(t+="&rose_username=true"),o.hasTimestamp&&(t+="&timezone="+o.timezone),progress_data=angular.copy(o.data);for(var a=0;a<progress_data.length;a++)for(var r=progress_data[a],s=0;s<r.tracks.length;s++){for(var i=r.tracks[s],m=[],g=0;g<i.units.length;g++){var c=i.units[g];c.toggled&&m.push(c.name)}i.units=m}t+="&progress_data="+encodeURIComponent(JSON.stringify(progress_data)),console.log(t),l.open(t,"_blank"),e.close()}}]);
