...
;angular.module("ManageControllers",[]).controller("ManageCtrl",["$modal","teams","api","snackbar","oAuth",function(e,t,a,r,o){this.items=t.teams;var n=this;this.toggleCreateTeamModal=function(){var s=e.open({templateUrl:"/static/teams/partials/modals/create_team_modal.html",controller:"CreateTeamModalInstanceCtrl",controllerAs:"modal",resolve:{user:function(){return o.getUserInfo()}}});s.result.then(function(e){r.create("Creating team...",1),a.insertTeam(e).then(function(e){r.remove(1),r.createWithTimeout("<b>Success!</b> Team created"),void 0==t.teams&&(t.teams=[],n.items=t.teams),t.teams.push(e)},function(){r.remove(1),r.createWithTimeout("<b>Error!</b> Team not created")})})}}]).controller("ManageTeamCtrl",["$routeParams","$modal","teams","$scope","snackbar","api","$location","user",function(e,t,a,r,o,n,s,i){for(var m=a.teams,l=-1,c=0;c<m.length;c++)if(m[c].team_key==e.team_key){this.team=m[c],l=c;break}this.goToSweep=function(){s.path(s.path()+"/sweeps")};var u=0,h=this,p=r.$watch(function(){return h.team},function(){u++,h.onInputMadeDirty(u)},!0);this.onInputMadeDirty=function(e){e>1&&(o.createWithTimeout("<b>Warning!</b> You must press submit to save your changes"),p())},this.deleteMember=function(e){for(var t=h.team.members,a=0;a<t.length;a++)if(t[a].email==e.email){t.splice(a,1);break}},this.saveTeam=function(){o.create("Saving team...",3),n.insertTeam(h.team).then(function(){o.remove(3),o.createWithTimeout("<b>Success!</b> Team saved")},function(){o.remove(3),o.createWithTimeout("<b>Error!</b> Team not saved")})},this.toggleDeleteTeamModal=function(){var e=t.open({templateUrl:"/static/teams/partials/modals/delete_team_modal.html",controller:"DeleteTeamModalInstanceCtrl",controllerAs:"modal"});e.result.then(function(){m.splice(c,1),o.create("Deleting team...",2),n.deleteTeam(h.team).then(function(){o.remove(2),o.createWithTimeout("<b>Success!</b> Team deleted")},function(){o.remove(2),o.createWithTimeout("<b>Error!</b> Team not deleted")}),s.path("/manage")})},this.toggleCreateMemberModal=function(){var e=t.open({templateUrl:"/static/teams/partials/modals/create_member_modal.html",controller:"NewMemberModalInstanceCtrl",controllerAs:"modal"});e.result.then(function(e){var t={email:e,visibility:"NOT_CHOSEN"};void 0==h.team.members&&(h.team.members=[]),e==i.email&&(t.visibility="ALL_MEMBERS"),h.team.members.push(t),h.team.newMembers=!0})},this.visibilityOptions={NOT_CHOSEN:"No Response",ALL_MEMBERS:"Progress visible by everyone",TEAM_LEADER:"Progress visible by leader only"}}]).controller("SweepsTeamCtrl",["$routeParams","$modal","teams","sweeps","$location","progress","snackbar","api",function(e,t,a,r,o,n,s,i){var m=a.teams;this.sweeps=r.sweeps||[];var l=-1;this.today=new Date,this.timezones=["UTC","Eastern","Central","Mountain","Pacific"],this.done=function(){o.path("/manage/"+e.team_key)};for(var c=0;c<m.length;c++)if(m[c].team_key==e.team_key){this.team=m[c],l=c;break}for(var c=0;c<this.sweeps.length;c++){var u=this.sweeps[c];u.hourNum=parseInt(u.hour);var h=new Date;h.setFullYear(u.year),h.setMonth(parseInt(u.month)-1,parseInt(u.day)),u.dt=h}this.saveSweep=function(e){s.create("Saving Sweep...",6),e.hour=e.hourNum.toString(),e.year=e.dt.getFullYear().toString(),e.month=(e.dt.getMonth()+1).toString(),e.day=e.dt.getDate().toString(),i.insertSweep(e).then(function(){s.remove(6),s.createWithTimeout("<b>Success!</b> Sweep saved")},function(){s.remove(6),s.createWithTimeout("<b>Error!</b> Sweep not saved")})};var p=this;this.deleteSweep=function(e){s.create("Removing Sweep...",7),i.deleteSweep(e).then(function(){for(var t=0;t<p.sweeps.length;t++)if(e.sweep_key===p.sweeps[t].sweep_key){p.sweeps.splice(t,1);break}s.remove(7),s.createWithTimeout("<b>Success!</b> Sweep removed")},function(){s.remove(7),s.createWithTimeout("<b>Error!</b> Sweep not removed")})},this.stopEvent=function(e){e.preventDefault(),e.stopPropagation()},this.toggleSweepOptionsModal=function(e){var a=t.open({templateUrl:"/static/teams/partials/modals/export_progress_modal.html",controller:"SweepOptionsModalInstanceCtrl",controllerAs:"modal",resolve:{team:function(){return n}}});a.result.then(function(t){e.options=t})},this.toggleCreateSweepDialog=function(){var a=t.open({templateUrl:"/static/teams/partials/modals/create_sweep_modal.html",controller:"NewSweepModalInstanceCtrl",controllerAs:"modal",resolve:{team_key:function(){return e.team_key},progress:function(){return n}}});a.result.then(function(e){s.create("Creating Sweep...",8),e.hour=e.hourNum.toString(),e.year=e.dt.getFullYear().toString(),e.month=(e.dt.getMonth()+1).toString(),e.day=e.dt.getDate().toString(),i.insertSweep(e).then(function(e){console.log(e),e.hourNum=parseInt(e.hour);var t=new Date;t.setFullYear(e.year),t.setMonth(parseInt(e.month)-1,parseInt(e.day)),e.dt=t,p.sweeps.push(e),s.remove(8),s.createWithTimeout("<b>Success!</b> Sweep created")},function(){s.remove(8),s.createWithTimeout("<b>Error!</b> Sweep not created")})})}}]);
;angular.module("ModalControllers",[]).controller("ModalToggleCtrl",["$modal",function(t){this.toggleSignOutModal=function(){t.open({templateUrl:"logout_modal.html",controller:"SimpleModalInstanceCtrl",controllerAs:"modal"})},this.toggleEditProfileModal=function(){t.open({templateUrl:"edit_profile_modal.html",controller:"SimpleModalInstanceCtrl",controllerAs:"modal"})}}]).controller("SimpleModalInstanceCtrl",["$modalInstance",function(t){this.cancel=function(){t.dismiss("cancel")}}]).controller("NewMemberModalInstanceCtrl",["$modalInstance","$controller",function(t,e){angular.extend(this,e("SimpleModalInstanceCtrl",{$modalInstance:t})),this.email="",this.addMember=function(e){return e=e.trim(),0===e.length?void t.dismiss("cancel"):(e.indexOf("@")<0&&(e+="@gmail.com"),void t.close(e))}}]).controller("DeleteTeamModalInstanceCtrl",["$modalInstance","$controller",function(t,e){angular.extend(this,e("SimpleModalInstanceCtrl",{$modalInstance:t})),this.remove=function(){t.close()}}]).controller("CreateTeamModalInstanceCtrl",["$modalInstance","$controller","user",function(t,e,n){angular.extend(this,e("SimpleModalInstanceCtrl",{$modalInstance:t})),this.teamName="",this.teamMembers="",this.includeLeader=!1;var o=this;this.add=function(){for(var e={name:o.teamName,leader:n.email,members:[]},a=o.teamMembers.split(","),l=0;l<a.length;l++){var r=a[l].trim();0!==r.length&&(r.indexOf("@")<0&&(r+="@gmail.com"),e.members.push({email:r,visibility:"NOT_CHOSEN"}))}o.includeLeader&&e.members.push({email:n.email,visibility:"ALL_MEMBERS"}),t.close(e)}}]).controller("ExportModalParentCtrl",["$modalInstance","$controller","team","$window",function(t,e,n){angular.extend(this,e("SimpleModalInstanceCtrl",{$modalInstance:t})),this.team=n,this.fullname=!0,this.username=!0,this.hasTimestamp=!0,this.pointValue="points",this.pointsPerUnit=parseInt(localStorage.getItem("ppu"))||1,this.pointsPerTask=parseInt(localStorage.getItem("ppt"))||1,this.includeCourseProgress=!1,this.includeTrackProgress=!1,this.timezone="Eastern",this.timezones=["UTC","Eastern","Central","Mountain","Pacific"],this.data=[];var o=this;if(n.members_progress.length>0)for(var a=n.members_progress[0].course_progress,l=0;l<a.length;l++){for(var r={name:a[l].name,tracks:[],toggled:!1},s=a[l].track_progress,i=0;i<s.length;i++){for(var c={name:s[i].name,units:[],toggled:!1},m=s[i].unit_progress,d=0;d<m.length;d++){var g={name:m[d].name,toggled:!1};c.units.push(g)}r.tracks.push(c)}this.data.push(r)}var u=function(t){t.toggled=!0;for(var e=0;e<t.units.length;e++)if(!t.units[e].toggled){t.toggled=!1;break}},p=function(t){t.toggled=!0;for(var e=0;e<t.tracks.length;e++)if(!t.tracks[e].toggled){t.toggled=!1;break}};this.toggleCourse=function(t){for(var e=t.tracks,n=0;n<e.length;n++){for(var o=e[n].units,a=0;a<o.length;a++)o[a].toggled=!t.toggled;e[n].toggled=!t.toggled}t.toggled=!t.toggled},this.toggleTrack=function(t,e){for(var n=e.units,o=0;o<n.length;o++)n[o].toggled=!e.toggled;e.toggled=!e.toggled,p(t)},this.unitToggled=function(t,e){u(e),p(t)},this.generate=function(){var t="team_urlsafe="+n.team_key;o.fullname&&(t+="&student_name=true"),o.username&&(t+="&rose_username=true"),o.hasTimestamp&&(t+="&timezone="+o.timezone),o.includeCourseProgress&&(t+="&course_progress=true"),o.includeTrackProgress&&(t+="&track_progress=true"),"points"===o.pointValue?(t+="&ppu="+o.pointsPerUnit,localStorage.setItem("ppu",o.pointsPerUnit)):(t+="&ppt="+o.pointsPerTask,localStorage.setItem("ppt",o.pointsPerTask));for(var e=angular.copy(o.data),a=0;a<e.length;a++)for(var l=e[a],r=0;r<l.tracks.length;r++){for(var s=l.tracks[r],i=[],c=0;c<s.units.length;c++){var m=s.units[c];m.toggled&&i.push(m.name)}s.units=i}var d=JSON.stringify(e);t+="&progress_data="+d,this.onPostGenerate(t)}}]).controller("ExportModalInstanceCtrl",["$modalInstance","$controller","team","$window",function(t,e,n,o){angular.extend(this,e("ExportModalParentCtrl",{$modalInstance:t,$controller:e,team:n})),this.onPostGenerate=function(e){var n="http://"+o.location.host+"/teams/export.csv?";o.open(n+encodeURI(e),"_blank"),t.close()},this.doneButtonText="Generate"}]).controller("NewSweepModalInstanceCtrl",["$modalInstance","$controller","team_key","$modal","progress",function(t,e,n,o,a){angular.extend(this,e("SimpleModalInstanceCtrl",{$modalInstance:t})),this.sweep={dt:new Date,team_key:n,options:"",hourNum:12,tz:"Eastern"},this.timezones=["UTC","Eastern","Central","Mountain","Pacific"],this.today=new Date,this.stopEvent=function(t){t.preventDefault(),t.stopPropagation()},this.addSweep=function(){t.close(this.sweep)};var l=this;this.toggleSweepOptionsModal=function(){var t=o.open({templateUrl:"/static/teams/partials/modals/export_progress_modal.html",controller:"SweepOptionsModalInstanceCtrl",controllerAs:"modal",resolve:{team:function(){return a}}});t.result.then(function(t){l.options=t})}}]).controller("SweepOptionsModalInstanceCtrl",["$modalInstance","$controller","team",function(t,e,n){angular.extend(this,e("ExportModalParentCtrl",{$modalInstance:t,$controller:e,team:n})),this.onPostGenerate=function(e){t.close(e)},this.doneButtonText="Done"}]);
