...
;angular.module("ManageControllers",[]).controller("ManageCtrl",["$modal","teams","api","snackbar","oAuth",function(e,t,a,r,o){this.items=t.teams;var n=this;this.toggleCreateTeamModal=function(){var s=e.open({templateUrl:"/static/teams/partials/modals/create_team_modal.html",controller:"CreateTeamModalInstanceCtrl",controllerAs:"modal",resolve:{user:function(){return o.getUserInfo()}}});s.result.then(function(e){r.create("Creating team...",1),a.insertTeam(e).then(function(e){r.remove(1),r.createWithTimeout("<b>Success!</b> Team created"),void 0==t.teams&&(t.teams=[],n.items=t.teams),t.teams.push(e)},function(){r.remove(1),r.createWithTimeout("<b>Error!</b> Team not created")})})}}]).controller("ManageTeamCtrl",["$routeParams","$modal","teams","$scope","snackbar","api","$location","user",function(e,t,a,r,o,n,s,m){for(var i=a.teams,l=-1,c=0;c<i.length;c++)if(i[c].team_key==e.team_key){this.team=i[c],l=c;break}this.goToSweep=function(){s.path(s.path()+"/sweeps")};var u=0,h=this,p=r.$watch(function(){return h.team},function(){u++,h.onInputMadeDirty(u)},!0);this.onInputMadeDirty=function(e){e>1&&(o.createWithTimeout("<b>Warning!</b> You must press submit to save your changes"),p())},this.deleteMember=function(e){for(var t=h.team.members,a=0;a<t.length;a++)if(t[a].email==e.email){t.splice(a,1);break}},this.saveTeam=function(){o.create("Saving team...",3),n.insertTeam(h.team).then(function(){o.remove(3),o.createWithTimeout("<b>Success!</b> Team saved")},function(){o.remove(3),o.createWithTimeout("<b>Error!</b> Team not saved")})},this.toggleDeleteTeamModal=function(){var e=t.open({templateUrl:"/static/teams/partials/modals/delete_team_modal.html",controller:"DeleteTeamModalInstanceCtrl",controllerAs:"modal"});e.result.then(function(){i.splice(c,1),o.create("Deleting team...",2),n.deleteTeam(h.team).then(function(){o.remove(2),o.createWithTimeout("<b>Success!</b> Team deleted")},function(){o.remove(2),o.createWithTimeout("<b>Error!</b> Team not deleted")}),s.path("/manage")})},this.toggleCreateMemberModal=function(){var e=t.open({templateUrl:"/static/teams/partials/modals/create_member_modal.html",controller:"NewMemberModalInstanceCtrl",controllerAs:"modal"});e.result.then(function(e){var t={email:e,visibility:"NOT_CHOSEN"};void 0==h.team.members&&(h.team.members=[]),e==m.email&&(t.visibility="ALL_MEMBERS"),h.team.members.push(t),h.team.newMembers=!0})},this.visibilityOptions={NOT_CHOSEN:"No Response",ALL_MEMBERS:"Progress visible by everyone",TEAM_LEADER:"Progress visible to leader only"}}]).controller("SweepsTeamCtrl",["$routeParams","$modal","teams","sweeps","$location",function(e,t,a,r,o){var n=a.teams;this.sweeps=r.sweeps;var s=-1;this.today=new Date,this.done=function(){o.path("/manage/"+e.team_key)};for(var m=0;m<n.length;m++)if(n[m].team_key==e.team_key){this.team=n[m],s=m;break}for(var m=0;m<this.sweeps.length;m++){var i=this.sweeps[m];i.hour=parseInt(i.hour);var l=new Date;l.setFullYear(i.year),l.setMonth(parseInt(i.month)-1,parseInt(i.day)),i.dt=l}this.stopEvent=function(e){e.preventDefault(),e.stopPropagation()}}]);
;angular.module("ModalControllers",[]).controller("ModalToggleCtrl",["$modal",function(e){this.toggleSignOutModal=function(){e.open({templateUrl:"logout_modal.html",controller:"SimpleModalInstanceCtrl",controllerAs:"modal"})},this.toggleEditProfileModal=function(){e.open({templateUrl:"edit_profile_modal.html",controller:"SimpleModalInstanceCtrl",controllerAs:"modal"})}}]).controller("SimpleModalInstanceCtrl",["$modalInstance",function(e){this.cancel=function(){e.dismiss("cancel")}}]).controller("NewMemberModalInstanceCtrl",["$modalInstance","$controller",function(e,t){angular.extend(this,t("SimpleModalInstanceCtrl",{$modalInstance:e})),this.email="",this.addMember=function(t){return t=t.trim(),0===t.length?void e.dismiss("cancel"):(t.indexOf("@")<0&&(t+="@gmail.com"),void e.close(t))}}]).controller("DeleteTeamModalInstanceCtrl",["$modalInstance","$controller",function(e,t){angular.extend(this,t("SimpleModalInstanceCtrl",{$modalInstance:e})),this.remove=function(){e.close()}}]).controller("CreateTeamModalInstanceCtrl",["$modalInstance","$controller","user",function(e,t,n){angular.extend(this,t("SimpleModalInstanceCtrl",{$modalInstance:e})),this.teamName="",this.teamMembers="",this.includeLeader=!1;var o=this;this.add=function(){for(var t={name:o.teamName,leader:n.email,members:[]},l=o.teamMembers.split(","),a=0;a<l.length;a++){var r=l[a].trim();0!==r.length&&(r.indexOf("@")<0&&(r+="@gmail.com"),t.members.push({email:r,visibility:"NOT_CHOSEN"}))}o.includeLeader&&t.members.push({email:n.email,visibility:"ALL_MEMBERS"}),e.close(t)}}]).controller("ExportModalInstanceCtrl",["$modalInstance","$controller","team","$window",function(e,t,n,o){angular.extend(this,t("SimpleModalInstanceCtrl",{$modalInstance:e})),this.team=n,this.fullname=!0,this.username=!0,this.hasTimestamp=!0,this.pointValue="points",this.pointsPerUnit=parseInt(localStorage.getItem("ppu"))||1,this.pointsPerTask=parseInt(localStorage.getItem("ppt"))||1,this.includeCourseProgress=!1,this.includeTrackProgress=!1,this.timezone="Eastern",this.timezones=["UTC","Eastern","Central","Mountain","Pacific"],this.data=[];var l=this;if(n.members_progress.length>0)for(var a=n.members_progress[0].course_progress,r=0;r<a.length;r++){for(var s={name:a[r].name,tracks:[],toggled:!1},i=a[r].track_progress,g=0;g<i.length;g++){for(var c={name:i[g].name,units:[],toggled:!1},m=i[g].unit_progress,d=0;d<m.length;d++){var u={name:m[d].name,toggled:!1};c.units.push(u)}s.tracks.push(c)}this.data.push(s)}var h=function(e){e.toggled=!0;for(var t=0;t<e.units.length;t++)if(!e.units[t].toggled){e.toggled=!1;break}},p=function(e){e.toggled=!0;for(var t=0;t<e.tracks.length;t++)if(!e.tracks[t].toggled){e.toggled=!1;break}};this.toggleCourse=function(e){for(var t=e.tracks,n=0;n<t.length;n++){for(var o=t[n].units,l=0;l<o.length;l++)o[l].toggled=!e.toggled;t[n].toggled=!e.toggled}e.toggled=!e.toggled},this.toggleTrack=function(e,t){for(var n=t.units,o=0;o<n.length;o++)n[o].toggled=!t.toggled;t.toggled=!t.toggled,p(e)},this.unitToggled=function(e,t){h(t),p(e)},this.generate=function(){var e="http://"+o.location.host+"/teams/export.csv";e+="?team_urlsafe="+n.team_key,l.fullname&&(e+="&student_name=true"),l.username&&(e+="&rose_username=true"),l.hasTimestamp&&(e+="&timezone="+l.timezone),l.includeCourseProgress&&(e+="&course_progress=true"),l.includeTrackProgress&&(e+="&track_progress=true"),"points"===l.pointValue?(e+="&ppu="+l.pointsPerUnit,localStorage.setItem("ppu",l.pointsPerUnit)):(e+="&ppt="+l.pointsPerTask,localStorage.setItem("ppt",l.pointsPerTask));for(var t=angular.copy(l.data),a=0;a<t.length;a++)for(var r=t[a],s=0;s<r.tracks.length;s++){for(var i=r.tracks[s],g=[],c=0;c<i.units.length;c++){var m=i.units[c];m.toggled&&g.push(m.name)}i.units=g}e+="&progress_data="+encodeURIComponent(JSON.stringify(t)),l.onPostGenerate(e)},this.onPostGenerate=function(t){o.open(t,"_blank"),e.close()}}]);
