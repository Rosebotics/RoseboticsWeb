...
;angular.module("ModalControllers",[]).controller("ModalToggleCtrl",["$modal",function(e){this.toggleSignOutModal=function(){e.open({templateUrl:"logout_modal.html",controller:"SimpleModalInstanceCtrl",controllerAs:"modal"})},this.toggleEditProfileModal=function(){e.open({templateUrl:"edit_profile_modal.html",controller:"SimpleModalInstanceCtrl",controllerAs:"modal"})}}]).controller("SimpleModalInstanceCtrl",["$modalInstance",function(e){this.cancel=function(){e.dismiss("cancel")}}]).controller("NewMemberModalInstanceCtrl",["$modalInstance","$controller",function(e,t){angular.extend(this,t("SimpleModalInstanceCtrl",{$modalInstance:e})),this.email="",this.addMember=function(t){return t=t.trim(),0===t.length?void e.dismiss("cancel"):(t.indexOf("@")<0&&(t+="@gmail.com"),void e.close(t))}}]).controller("DeleteTeamModalInstanceCtrl",["$modalInstance","$controller",function(e,t){angular.extend(this,t("SimpleModalInstanceCtrl",{$modalInstance:e})),this.remove=function(){e.close()}}]).controller("CreateTeamModalInstanceCtrl",["$modalInstance","$controller","user",function(e,t,n){angular.extend(this,t("SimpleModalInstanceCtrl",{$modalInstance:e})),this.teamName="",this.teamMembers="",this.includeLeader=!1;var o=this;this.add=function(){for(var t={name:o.teamName,leader:n.email,members:[]},r=o.teamMembers.split(","),a=0;a<r.length;a++){var l=r[a].trim();0!==l.length&&(l.indexOf("@")<0&&(l+="@gmail.com"),t.members.push({email:l,visibility:"NOT_CHOSEN"}))}o.includeLeader&&t.members.push({email:n.email,visibility:"ALL_MEMBERS"}),e.close(t)}}]).controller("ExportModalInstanceCtrl",["$modalInstance","$controller","team","$window",function(e,t,n,o){angular.extend(this,t("SimpleModalInstanceCtrl",{$modalInstance:e})),this.team=n,this.fullname=!0,this.username=!0,this.hasTimestamp=!0,this.includeCourseProgress=!1,this.includeTrackProgress=!1,this.timezone="Eastern",this.timezones=["UTC","Eastern","Central","Mountain","Pacific"],this.data=[];var r=this;if(console.log(n),n.members_progress.length>0)for(var a=n.members_progress[0].course_progress,l=0;l<a.length;l++){for(var s={name:a[l].name,tracks:[],toggled:!1},i=a[l].track_progress,g=0;g<i.length;g++){for(var c={name:i[g].name,units:[],toggled:!1},m=i[g].unit_progress,d=0;d<m.length;d++){var u={name:m[d].name,toggled:!1};c.units.push(u)}s.tracks.push(c)}this.data.push(s)}var h=function(e){e.toggled=!0;for(var t=0;t<e.units.length;t++)if(!e.units[t].toggled){e.toggled=!1;break}},f=function(e){e.toggled=!0;for(var t=0;t<e.tracks.length;t++)if(!e.tracks[t].toggled){e.toggled=!1;break}};this.toggleCourse=function(e){for(var t=e.tracks,n=0;n<t.length;n++){for(var o=t[n].units,r=0;r<o.length;r++)o[r].toggled=!e.toggled;t[n].toggled=!e.toggled}e.toggled=!e.toggled},this.toggleTrack=function(e,t){for(var n=t.units,o=0;o<n.length;o++)n[o].toggled=!t.toggled;t.toggled=!t.toggled,f(e)},this.unitToggled=function(e,t){h(t),f(e)},this.generate=function(){var t="http://"+o.location.host+"/teams/export.csv";t+="?team_urlsafe="+n.team_key,r.fullname&&(t+="&student_name=true"),r.username&&(t+="&rose_username=true"),r.hasTimestamp&&(t+="&timezone="+r.timezone),r.includeCourseProgress&&(t+="&course_progress=true"),r.includeTrackProgress&&(t+="&track_progress=true"),progress_data=angular.copy(r.data);for(var a=0;a<progress_data.length;a++)for(var l=progress_data[a],s=0;s<l.tracks.length;s++){for(var i=l.tracks[s],g=[],c=0;c<i.units.length;c++){var m=i.units[c];m.toggled&&g.push(m.name)}i.units=g}t+="&progress_data="+encodeURIComponent(JSON.stringify(progress_data)),r.onPostGenerate(t),e.close()},this.onPostGenerate=function(e){o.open(e,"_blank")}}]);
