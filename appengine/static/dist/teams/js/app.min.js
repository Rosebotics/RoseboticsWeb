...
;angular.module("ManageControllers",[]).controller("ManageCtrl",["$modal","teams","api","snackbar","oAuth",function(e,t,a,r,o){this.items=t.teams;var n=this;this.toggleCreateTeamModal=function(){var s=e.open({templateUrl:"/static/teams/partials/modals/create_team_modal.html",controller:"CreateTeamModalInstanceCtrl",controllerAs:"modal",resolve:{user:function(){return o.getUserInfo()}}});s.result.then(function(e){r.create("Creating team...",1),a.insertTeam(e).then(function(e){r.remove(1),r.createWithTimeout("<b>Success!</b> Team created"),void 0==t.teams&&(t.teams=[],n.items=t.teams),t.teams.push(e)},function(){r.remove(1),r.createWithTimeout("<b>Error!</b> Team not created")})})}}]).controller("ManageTeamCtrl",["$routeParams","$modal","teams","$scope","snackbar","api","$location","user",function(e,t,a,r,o,n,s,i){for(var m=a.teams,l=-1,c=0;c<m.length;c++)if(m[c].team_key==e.team_key){this.team=m[c],l=c;break}this.goToSweep=function(){s.path(s.path()+"/sweeps")};var u=0,p=this,h=r.$watch(function(){return p.team},function(){u++,p.onInputMadeDirty(u)},!0);this.onInputMadeDirty=function(e){e>1&&(o.createWithTimeout("<b>Warning!</b> You must press submit to save your changes"),h())},this.deleteMember=function(e){for(var t=p.team.members,a=0;a<t.length;a++)if(t[a].email==e.email){t.splice(a,1);break}},this.saveTeam=function(){o.create("Saving team...",3),n.insertTeam(p.team).then(function(){o.remove(3),o.createWithTimeout("<b>Success!</b> Team saved")},function(){o.remove(3),o.createWithTimeout("<b>Error!</b> Team not saved")})},this.toggleDeleteTeamModal=function(){var e=t.open({templateUrl:"/static/teams/partials/modals/delete_team_modal.html",controller:"DeleteTeamModalInstanceCtrl",controllerAs:"modal"});e.result.then(function(){m.splice(c,1),o.create("Deleting team...",2),n.deleteTeam(p.team).then(function(){o.remove(2),o.createWithTimeout("<b>Success!</b> Team deleted")},function(){o.remove(2),o.createWithTimeout("<b>Error!</b> Team not deleted")}),s.path("/manage")})},this.toggleCreateMemberModal=function(){var e=t.open({templateUrl:"/static/teams/partials/modals/create_member_modal.html",controller:"NewMemberModalInstanceCtrl",controllerAs:"modal"});e.result.then(function(e){var t={email:e,visibility:"NOT_CHOSEN"};void 0==p.team.members&&(p.team.members=[]),e==i.email&&(t.visibility="ALL_MEMBERS"),p.team.members.push(t),p.team.newMembers=!0})},this.visibilityOptions={NOT_CHOSEN:"No Response",ALL_MEMBERS:"Progress visible by everyone",TEAM_LEADER:"Progress visible by leader only"}}]).controller("SweepsTeamCtrl",["$routeParams","$modal","teams","sweeps","$location","progress","snackbar","api","$scope",function(e,t,a,r,o,n,s,i){var m=a.teams;this.sweeps=r.sweeps||[];var l=-1;this.today=new Date,this.timezones=["UTC","Eastern","Central","Mountain","Pacific"],this.done=function(){o.path("/manage/"+e.team_key)};for(var c=0;c<m.length;c++)if(m[c].team_key==e.team_key){this.team=m[c],l=c;break}for(var u=this,c=0;c<this.sweeps.length;c++){var p=this.sweeps[c];p.hourNum=parseInt(p.hour);var h=new Date(0);h.setFullYear(p.year),h.setMonth(parseInt(p.month)-1,parseInt(p.day)),p.dt=h}this.saveSweep=function(e){s.create("Saving Sweep...",6),e.hour=e.hourNum.toString(),e.year=e.dt.getFullYear().toString(),e.month=(e.dt.getMonth()+1).toString(),e.day=e.dt.getDate().toString(),i.insertSweep(e).then(function(){s.remove(6),s.createWithTimeout("<b>Success!</b> Sweep saved")},function(){s.remove(6),s.createWithTimeout("<b>Error!</b> Sweep not saved")})},this.deleteSweep=function(e){s.create("Removing Sweep...",7),i.deleteSweep(e).then(function(){for(var t=0;t<u.sweeps.length;t++)if(e.sweep_key===u.sweeps[t].sweep_key){u.sweeps.splice(t,1);break}s.remove(7),s.createWithTimeout("<b>Success!</b> Sweep removed")},function(){s.remove(7),s.createWithTimeout("<b>Error!</b> Sweep not removed")})},this.stopEvent=function(e){e.preventDefault(),e.stopPropagation()},this.toggleSweepOptionsModal=function(e){var a=t.open({templateUrl:"/static/teams/partials/modals/export_progress_modal.html",controller:"SweepOptionsModalInstanceCtrl",controllerAs:"modal",resolve:{team:function(){return n},optionString:function(){return e.options}}});a.result.then(function(t){e.options=t})},this.toggleCreateSweepDialog=function(){var a=t.open({templateUrl:"/static/teams/partials/modals/create_sweep_modal.html",controller:"NewSweepModalInstanceCtrl",controllerAs:"modal",resolve:{team_key:function(){return e.team_key},progress:function(){return n}}});a.result.then(function(e){s.create("Creating Sweep...",8),e.hour=e.hourNum.toString(),e.year=e.dt.getFullYear().toString(),e.month=(e.dt.getMonth()+1).toString(),e.day=e.dt.getDate().toString(),i.insertSweep(e).then(function(e){console.log(e),e.hourNum=parseInt(e.hour);var t=new Date(0);t.setFullYear(e.year),t.setMonth(parseInt(e.month)-1,parseInt(e.day)),e.dt=t,void 0==r.sweeps&&(r.sweeps=[],u.sweeps=r.sweeps);for(var a=!1,o=0;o<u.sweeps.length;o++)if(u.sweeps[o].dt.getTime()<e.dt.getTime()||u.sweeps[o].dt.getTime()===e.dt.getTime()&&u.sweeps[o].hourNum<e.hourNum){u.sweeps.splice(o,0,e),a=!0;break}a||u.sweeps.push(e),s.remove(8),s.createWithTimeout("<b>Success!</b> Sweep created")},function(){s.remove(8),s.createWithTimeout("<b>Error!</b> Sweep not created")})})}}]);
;angular.module("ModalControllers",[]).controller("ModalToggleCtrl",["$modal",function(t){this.toggleSignOutModal=function(){t.open({templateUrl:"logout_modal.html",controller:"SimpleModalInstanceCtrl",controllerAs:"modal"})},this.toggleEditProfileModal=function(){t.open({templateUrl:"edit_profile_modal.html",controller:"SimpleModalInstanceCtrl",controllerAs:"modal"})}}]).controller("SimpleModalInstanceCtrl",["$modalInstance",function(t){this.cancel=function(){t.dismiss("cancel")}}]).controller("NewMemberModalInstanceCtrl",["$modalInstance","$controller",function(t,e){angular.extend(this,e("SimpleModalInstanceCtrl",{$modalInstance:t})),this.email="",this.addMember=function(e){return e=e.trim(),0===e.length?void t.dismiss("cancel"):(e.indexOf("@")<0&&(e+="@gmail.com"),void t.close(e))}}]).controller("DeleteTeamModalInstanceCtrl",["$modalInstance","$controller",function(t,e){angular.extend(this,e("SimpleModalInstanceCtrl",{$modalInstance:t})),this.remove=function(){t.close()}}]).controller("CreateTeamModalInstanceCtrl",["$modalInstance","$controller","user",function(t,e,n){angular.extend(this,e("SimpleModalInstanceCtrl",{$modalInstance:t})),this.teamName="",this.teamMembers="",this.includeLeader=!1;var o=this;this.add=function(){for(var e={name:o.teamName,leader:n.email,members:[]},a=o.teamMembers.split(","),r=0;r<a.length;r++){var s=a[r].trim();0!==s.length&&(s.indexOf("@")<0&&(s+="@gmail.com"),e.members.push({email:s,visibility:"NOT_CHOSEN"}))}o.includeLeader&&e.members.push({email:n.email,visibility:"ALL_MEMBERS"}),t.close(e)}}]).controller("ExportModalParentCtrl",["$modalInstance","$controller","team","$window",function(t,e,n){angular.extend(this,e("SimpleModalInstanceCtrl",{$modalInstance:t})),this.team=n,this.fullname=!0,this.username=!0,this.hasTimestamp=!0,this.pointValue="points",this.pointsPerUnit=parseInt(localStorage.getItem("ppu"))||1,this.pointsPerTask=parseInt(localStorage.getItem("ppt"))||1,this.includeCourseProgress=!1,this.includeTrackProgress=!1,this.timezone="Eastern",this.timezones=["UTC","Eastern","Central","Mountain","Pacific"],this.data=[];if(n.members_progress.length>0)for(var o=n.members_progress[0].course_progress,a=0;a<o.length;a++){for(var r={name:o[a].name,tracks:[],toggled:!1},s=o[a].track_progress,l=0;l<s.length;l++){for(var i={name:s[l].name,units:[],toggled:!1},c=s[l].unit_progress,m=0;m<c.length;m++){var g={name:c[m].name,toggled:!1};i.units.push(g)}r.tracks.push(i)}this.data.push(r)}var d=function(t){t.toggled=!0;for(var e=0;e<t.units.length;e++)if(!t.units[e].toggled){t.toggled=!1;break}},u=function(t){t.toggled=!0;for(var e=0;e<t.tracks.length;e++)if(!t.tracks[e].toggled){t.toggled=!1;break}};this.toggleCourse=function(t){for(var e=t.tracks,n=0;n<e.length;n++){for(var o=e[n].units,a=0;a<o.length;a++)o[a].toggled=!t.toggled;e[n].toggled=!t.toggled}t.toggled=!t.toggled},this.toggleTrack=function(t,e){for(var n=e.units,o=0;o<n.length;o++)n[o].toggled=!e.toggled;e.toggled=!e.toggled,u(t)},this.unitToggled=function(t,e){d(e),u(t)},this.generate=function(){var t="team_urlsafe="+n.team_key;this.fullname&&(t+="&student_name=true"),this.username&&(t+="&rose_username=true"),this.hasTimestamp&&(t+="&timezone="+this.timezone),this.includeCourseProgress&&(t+="&course_progress=true"),this.includeTrackProgress&&(t+="&track_progress=true"),"points"===this.pointValue?(t+="&ppu="+this.pointsPerUnit,localStorage.setItem("ppu",this.pointsPerUnit)):(t+="&ppt="+this.pointsPerTask,localStorage.setItem("ppt",this.pointsPerTask));for(var e=angular.copy(this.data),o=0;o<e.length;o++)for(var a=e[o],r=0;r<a.tracks.length;r++){for(var s=a.tracks[r],l=[],i=0;i<s.units.length;i++){var c=s.units[i];c.toggled&&l.push(c.name)}s.units=l}var m=JSON.stringify(e);t+="&progress_data="+m,this.onPostGenerate(t)}}]).controller("ExportModalInstanceCtrl",["$modalInstance","$controller","team","$window",function(t,e,n,o){angular.extend(this,e("ExportModalParentCtrl",{$modalInstance:t,$controller:e,team:n})),this.onPostGenerate=function(e){var n="http://"+o.location.host+"/teams/export.csv?";o.open(n+encodeURI(e),"_blank"),t.close()},this.doneButtonText="Generate"}]).controller("NewSweepModalInstanceCtrl",["$modalInstance","$controller","team_key","$modal","progress",function(t,e,n,o,a){angular.extend(this,e("SimpleModalInstanceCtrl",{$modalInstance:t})),this.sweep={dt:new Date,team_key:n,options:"",hourNum:12,tz:"Eastern"},this.timezones=["UTC","Eastern","Central","Mountain","Pacific"],this.today=new Date,this.stopEvent=function(t){t.preventDefault(),t.stopPropagation()},this.addSweep=function(){t.close(this.sweep)};var r=this;this.toggleSweepOptionsModal=function(){var t=o.open({templateUrl:"/static/teams/partials/modals/export_progress_modal.html",controller:"SweepOptionsModalInstanceCtrl",controllerAs:"modal",resolve:{team:function(){return a},optionString:function(){return r.sweep.options}}});t.result.then(function(t){r.sweep.options=t})}}]).controller("SweepOptionsModalInstanceCtrl",["$modalInstance","$controller","team","optionString",function(t,e,n,o){if(angular.extend(this,e("ExportModalParentCtrl",{$modalInstance:t,$controller:e,team:n})),this.onPostGenerate=function(e){t.close(e)},this.doneButtonText="Done",console.log(o),""!==o){var a={};o=o.split("&");for(var r=0;r<o.length;r++){var s=o[r].split("=");a[s[0]]=s[1]}this.fullname="true"===a.student_name,this.username="true"===a.rose_username,this.hasTimestamp=void 0!=a.timezone,this.pointValue=a.ppu?"points":"tasks",this.pointsPerUnit=parseInt(a.ppu)||parseInt(localStorage.getItem("ppu"))||1,this.pointsPerTask=parseInt(a.ppt)||parseInt(localStorage.getItem("ppt"))||1,this.includeCourseProgress="true"===a.course_progress,this.includeTrackProgress="true"===a.track_progress,this.timezone=a.timezone||"Eastern",this.timezones=["UTC","Eastern","Central","Mountain","Pacific"];for(var l=JSON.parse(a.progress_data),r=0;r<this.data.length;r++)for(var i=this.data[r],c=0;c<i.tracks.length;c++)for(var m=i.tracks[c],g=l[r].tracks[c].units,d=0;d<m.units.length;d++){var u=m.units[d];u.toggled=-1!==g.indexOf(u.name)}}}]);
