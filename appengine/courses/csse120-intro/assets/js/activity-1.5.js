var activity = [
    ...
    "<b>1.</b> Which one of the following <em>constructs</em> a SimpleTurtle, as defined in the <em>rg</em> (short for rosegraphics) module?<br>",
    {
        ...
        choices : [ [ "<code>thing2 = rg.SimpleTurtle()</code>", true, "Correct! Be sure to always include those parentheses - they are critical!" ],
    ...
    {
        questionType : "multiple choice",
        choices : [ [ "<code>thing1 = rg.SimpleTurtle()<br>SimpleTurtle.forward(450)</code>", false, "This would attempt to make the SimpleTurtle <em>class</em> go forward.  You want a single, particular SimpleTurtle to go forward.  Try again." ],
