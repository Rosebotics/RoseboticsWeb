var activity = [
	...
	"<br><br><b>4.</b> Have you changed the value of the LEGO_NUMBER within the <b>libs/mqtt_remote_method_calls.py</b> file yet?<br>",
	{
		questionType: "multiple choice",
		choices: [
			["Nope, not yet, still set as 99.  One person on our team will change it when we have the robot connected, commit that change, transfer the change to the EV3, then everyone else will need to git update.", true, "Correct!  Great that will work out best."],
