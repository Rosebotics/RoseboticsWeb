...
var activity = [
	...
	"<br><br>",
	"<b>4.</b> How does one activity send data back to the activity that called it for a result?<br>",
	{
		questionType : "multiple choice",
		choices : [
				["Mutates the values in the intent that was used to start the activity", false, "Try again. " ],
				["Uses a different intent and set the result", true, "Correct. Along with Activity.RESULT_OK" ],
				["Calls startActivity and send a new intent with the data back", false, "Try again. You want to pop the current activity off the backstack by calling finish(); calling startActivity would push yet another copy of the original activity onto the stack." ],
		]
	},
	"<br><br>",
	"<b>5.</b> Note that the callback uses two codes: a request code and a result code.<br>",
	{
		questionType : "multiple choice",
		choices : [
